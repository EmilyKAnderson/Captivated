...
$(function(){
    $(".typed").typed({
        strings: [ "clients", "employees", "patients", "guests", "students", "members"],
        typeSpeed: 100,
        loop:false,
         // false = infinite
        backDelay: 3000
...
/* SETTINGS */
var i_v = {
    i_touchlistener     : '.par-frame',         // element to monitor for touches, set to null to use document. Otherwise use quotes. Eg. '.myElement'. Note: if the finger leaves this listener while still touching, movement is stopped.
    i_scrollElement     : '.par-frame',         // element (class) to be scrolled on touch movement
